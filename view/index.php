...
<main>
    <div class="contents">
        ...
        <div class="wellbeingtabs">
            ...
            <button class ="btn-mz"id="monbouton"><h2>MIND ZONE</h2></button>
        </div>
    </div>
    <div class="contents2">
      ...
      <div class="recentblogs">
        ...
        <div class="blogsdiv">
          ...
          <div class="individualrecentblog">
            <img src="../assets/img/wallpaper1.jpg" alt="test">
            <div class="recentblogcentent">
              <h4>Lorem ipsum, dolor sit amet </h4>
              <b>by ilyes chaabani , 4-11-2023</b>
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Adipisci mollitia amet itaque autem molestiae dolores,
                 sint ipsum vero neque in modi cupiditate veniam corrupti odio magnam enim aperiam, assumenda officiis.</p>
